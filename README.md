...
1. Clone and build:
```bash
git clone https://github.com/yourusername/gpt5-mcp.git
...
```bash
claude mcp add gpt5-server -e OPENAI_API_KEY=your-api-key-here -- node /path/to/gpt5-mcp/servers/gpt5-server/build/index.js
```
...
- **Issues**: [GitHub Issues](https://github.com/yourusername/gpt5-mcp/issues)
- **Discussions**: [GitHub Discussions](https://github.com/yourusername/gpt5-mcp/discussions)
